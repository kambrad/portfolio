...
let askUsText = document.querySelector(".ask-us-text"),
    ...
    arrow = document.querySelectorAll(".arrow")[1],
...
function contact(e) {
    ...
    // function ifReachedBottom(count) {
    //     if (count <= 0) {
    //     loadMore.style.opacity = "1";

    //     setTimeout(() => {
    //         loadMore.style.opacity = "0";
    //         contactForm.style.bottom = "20rem";
    //         contactForm.style.transition = "all 650ms ease";
    ...
    //         let yOffset = parseInt(w.pageYOffset),
    //         docElement = ((documentElement.scrollHeight - w.innerHeight) - 1) === yOffset;

    //         if (docElement) {
    //             ifReachedBottom(counter)
    //             ++counter;
    //         }
    //     })
    // }
    ...
    function geoLocationController() {
        let eleObj = [".home", ".about-footer"];
        let eleLength = eleObj.length;

        // for (let i = 0; (i && typeof i !== "string"), i < eleLength; ++i) {
        //     document.querySelector(eleObj[i]).style.filter = "blur(5px)";
        //     document.querySelector(eleObj[i]).style.transition = "filter 650ms ease";
        // }
    ...
    // readOption.addEventListener("click", (e) => _read(e));
