...
//     let vid = document.querySelectorAll(".vid"), info = document.querySelectorAll(".info-text"), displayImg = document.querySelectorAll(".display-img"), infoDes = null;
...
//             }
//             if (window.innerWidth <= 681) {
//                 displayImg[i].style.maxWidth = "100%";
//                 displayImg[i].style.objectPosition = "unset";
//             } else {
//                 displayImg[i].style.maxWidth = "65%";
//                 displayImg[i].style.objectPosition = "unset";
//             }
//             window.addEventListener("resize", (e) => {
//                 if (window.innerWidth > 681)
...
let info = document.querySelectorAll(".industry-info");

for (let i = 0; i < info.length; ++i) {
    let imgTag = info[i].querySelector(".img-tag"),
        displayTag = info[i].querySelector(".display-tag"),
        textTag = info[i].querySelector(".text-tag")
    ;
    imgTag.addEventListener("click", (e) => {
           displayTag.classList.add("display-tag-none");

           setTimeout(() => {
                displayTag.style.display = "none";
                
                imgTag.classList.add("img-tag-none");
           }, 550);
           textTag.classList.add("text-tag-active");
    })
}
